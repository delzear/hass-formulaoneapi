...
from custom_components.formulaone_api.const import FIRST_PRACTICE, PARSE_DATETIME_FORMAT, QUALIFYING, RACE, SECOND_PRACTICE, SPRINT, THIRD_PRACTICE
...
class NextEventSensor(FormulaOneSensor):
    ...
    def set_state(self):
        ...
        third_practice_date = dt.strptime(next_race[THIRD_PRACTICE]['date']+ " " + next_race[THIRD_PRACTICE]['time'], PARSE_DATETIME_FORMAT)
        qualifying_date = dt.strptime(next_race[QUALIFYING]['date']+ " " + next_race[QUALIFYING]['time'], PARSE_DATETIME_FORMAT)
        #sprint_date = dt.strptime(next_race[SPRINT]['date']+ " " + next_race[SPRINT]['time'], PARSE_DATETIME_FORMAT)
        race_date = dt.strptime(next_race['date']+ " " + next_race['time'], PARSE_DATETIME_FORMAT)
